...
var BridgeConnection = /** @class */ (function () {
    ...
    BridgeConnection.prototype.clickToolbarAction = function (toolbarId, actionLabel) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.send('clickToolbarAction', { toolbarId: toolbarId, actionLabel: actionLabel })];
            });
        });
    };
     ...
     */
    BridgeConnection.prototype.shutdown = function () {
        var _a, _b, _c;
        ...
        if (this.process) {
            ...
            (_a = this.process.stdout) === null || _a === void 0 ? void 0 : _a.removeAllListeners();
            (_b = this.process.stderr) === null || _b === void 0 ? void 0 : _b.removeAllListeners();
            (_c = this.process.stdin) === null || _c === void 0 ? void 0 : _c.removeAllListeners();
        }
        // Clear all pending requests and reject them silently
        // (these are expected to fail during cleanup)
        for (var _i = 0, _d = this.pendingRequests.entries(); _i < _d.length; _i++) {
            var _e = _d[_i], id = _e[0], reject = _e[1].reject;
            var err = new Error('Bridge shutting down');
            // Mark as expected shutdown error so it doesn't get logged
            err.isShutdownError = true;
            reject(err);
        }
