  ...
  a.window({ title: "Accessible Calculator" }, () => {
    a.vbox(() => {
      ...
      a.grid(4, () => {
        ...
        a.button("÷", { className: "divide", onClick: () => handleOperator("/"), "button" })
          .withId('btnDivide')
          .accessibility({
            label: "Divide",
        ...
        a.button("×", { className: "multiply", onClick: () => handleOperator("*"), "button" })
          .withId('btnMultiply')
          .accessibility({
            label: "Multiply",
        ...
        a.button("-", { className: "subtract", onClick: () => handleOperator("-"), "button" })
          .withId('btnSubtract')
          .accessibility({
            label: "Subtract",
        ...
        a.button("+", { className: "add", onClick: () => handleOperator("+"), "button" })
          .withId('btnAdd')
          .accessibility({
            label: "Add",
