  ...
  a.window({ title: "Accessible Calculator" }, () => {
    a.vbox(() => {
      ...
      a.grid(4, () => {
        ...
        a.button("÷", { className: "divide", onClick: () => handleOperator("/") })
          .withId('btnDivide')
          .accessibility({
            label: "Divide",
        ...
        a.button("×", { className: "multiply", onClick: () => handleOperator("*") })
          .withId('btnMultiply')
          .accessibility({
            label: "Multiply",
        ...
        a.button("-", { className: "subtract", onClick: () => handleOperator("-") })
          .withId('btnSubtract')
          .accessibility({
            label: "Subtract",
        ...
        a.button("+", { className: "add", onClick: () => handleOperator("+") })
          .withId('btnAdd')
          .accessibility({
            label: "Add",
