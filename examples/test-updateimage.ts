  ...
  a.window({ title: 'UpdateImage Test', width: 600, height: 400 }, (win) => {
    win.setContent(() => {
      a.vbox(() => {
        ...
        a.button('Update to Red Circle SVG', async () => {
        ...
        a.button('Update to Blue Square SVG', async () => {
