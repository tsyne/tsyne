/**
 * US English (en-US) Keyboard
 * Standard QWERTY layout with Fn layer for F-keys and navigation
...
/**
 * Build the US English keyboard UI with abc, symbols, and Fn modes
 */
export function buildKeyboard(a: App, k: KeyboardController): void {
  ...
  a.vbox(() => {
    ...
    // NAVIGATION + CURSOR: Esc Tab | Ins Del | Home End | PgUp PgDn
    a.hbox(() => {
