/**
 * UK English (en-GB) Keyboard
 * QWERTY with UK-specific symbols (£ instead of #)
...
/**
 * Build the UK English keyboard UI
 */
export function buildKeyboard(a: App, k: KeyboardController): void {
  a.vbox(() => {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // ROW 4: 123 £ ―――――― . ↵  (UK has £ directly accessible)
    // ═══════════════════════════════════════════════════════════════════════
    a.hbox(() => {
      k.register('mode', a.button('123').onClick(() => { k.toggleSymbols(); }).withId('key-mode'), '123');
      k.register('pound', a.button('£').onClick(() => k.symbol('£', 'pound')).withId('key-pound'), '£');
