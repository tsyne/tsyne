/**
 * Jest Tests for Aranet4 Monitor - Core Build Tests
 * Same tests as ported-apps/aranet/index.test.ts but with updated import path
 */
...
import {
  ...
  Aranet4Reading,
  AppSettings,
} from '../../../../../ported-apps/aranet/index';

jest.setTimeout(15000); // Increase timeout for async operations

describe('Aranet4Store (Core Build)', () => {
...
describe('Edge Cases (Core Build)', () => {
  let store: AranetStore;
