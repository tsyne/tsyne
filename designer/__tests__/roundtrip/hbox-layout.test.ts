...
describe('RoundTrip: HBox Horizontal Layout', () => {
  test('load and save with no edits', async () => {
    const code = `import { app, window, vbox, hbox, button } from 'tsyne';
...
app({ title: "Test" }, () => {
  window({ title: "Test" }, () => {
    ...
    const expected = `import { app, window, vbox, hbox, label } from 'tsyne';
...
app({ title: "Test" }, () => {
  ...
  test('multiple hbox containers', async () => {
    const original = `import { app, window, vbox, hbox, button, label } from 'tsyne';
...
app({ title: "Test" }, () => {
  window({ title: "Test" }, () => {
    ...
    const expected = `import { app, window, vbox, hbox, button, label } from 'tsyne';
