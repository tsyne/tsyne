...
vec3 getPaletteColor(float t, int palette) {
  if (palette == 0) return palette0(t);
  if (palette == 1) return palette1(t);
  if (palette == 2) return palette2(t);
  if (palette == 3) return palette3(t);
  if (palette == 4) return palette4(t);
  if (palette == 5) return palette5(t);
  if (palette == 6) return palette6(t);
  return palette7(t);
}
`;
